      ...
      <div class="cardList">
        ...
        <div class="cards__wrapper">
          <div
            ...
            style="--card-translateY-offset: 0%"
            ref="currentCardEl"
          >
...
export default {
  ...
  methods: {
    ...
    initCardEvents() {
      this.$refs.currentCardEl.addEventListener("pointermove", this.updateCard);
      this.$refs.currentCardEl.addEventListener("pointerout", (e) => {
